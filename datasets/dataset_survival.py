...
class SurvivalDatasetFactory:
    ...
    def __init__(self,
        ...
        self.csvData_root_dir = csvData_root_dir
        self.seed = seed
    ...
    def _setup_mcat(self):
        ...
        """
        self.signatures = pd.read_csv("{}metadata/signatures.csv".format(self.csvData_root_dir)) #pd.read_csv("./datasets_csv/metadata/signatures.csv")
        self.omic_names = []
    ...
    def _setup_survpath(self):
        ...
        self.signatures = pd.read_csv("{}metadata/{}_signatures.csv".format(self.csvData_root_dir, self.type_of_path)) #pd.read_csv("./datasets_csv/metadata/{}_signatures.csv".format(self.type_of_path))
    ...
    def _load_clinical_data(self):
        ...
        """
        path_to_data = "{}clinical_data/{}_clinical.csv".format(self.csvData_root_dir, self.study) #"./datasets_csv/clinical_data/{}_clinical.csv".format(self.study)
...
class SurvivalDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        Returns:
            - variable, based on the omics_format
        ...
        if self.omics_format == "gene": # TODO: A sequence of genes 1*N
            ...
            omic1 = torch.tensor(self.omics_data_dict["rna"][self.omics_data_dict["rna"]["temp_index"] == case_id][self.omic_names[0]].iloc[0]) #.values[0] -> .iloc[0]
            omic2 = torch.tensor(self.omics_data_dict["rna"][self.omics_data_dict["rna"]["temp_index"] == case_id][self.omic_names[1]].iloc[0]) #.values[0]
            omic3 = torch.tensor(self.omics_data_dict["rna"][self.omics_data_dict["rna"]["temp_index"] == case_id][self.omic_names[2]].iloc[0]) #.values[0]
            omic4 = torch.tensor(self.omics_data_dict["rna"][self.omics_data_dict["rna"]["temp_index"] == case_id][self.omic_names[3]].iloc[0]) #.values[0]
            omic5 = torch.tensor(self.omics_data_dict["rna"][self.omics_data_dict["rna"]["temp_index"] == case_id][self.omic_names[4]].iloc[0]) #.values[0]
            omic6 = torch.tensor(self.omics_data_dict["rna"][self.omics_data_dict["rna"]["temp_index"] == case_id][self.omic_names[5]].iloc[0]) #.values[0]
            ...
            for i in range(self.num_pathways):
                omic_list.append(torch.tensor(self.omics_data_dict["rna"][self.omics_data_dict["rna"]["temp_index"] == case_id][self.omic_names[i]].iloc[0]))
